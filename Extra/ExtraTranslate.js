...
/**
  * Magsalin ng text mula sa <from> hanggang <to> gamit ang Bing engine
  * @async
  * @method bing
  * @param {string} text Text na isasalin
  * @param {string} from sa Pinagmulang wika
  * @param {string} to Destination language
  * @return {string} Na-translate na text
  * @example
...
/**
  * Magsalin ng text mula sa <from> hanggang <to> gamit ang Google engine
  * @async
  * @method bing
  * @param  {string} text  Tekstong isasalin
  * @param  {string} [from="auto"]  Pinagmulang wika
  * @param  {string} to    Wika ng patutunguhan
  * @return {string} Na-translate na text
  * @example
...
/**
  * Alamin ang wikang ginagamit ng teksto
  * @async
  * @method detect
  * @param  {string} text  Pinagmulan ng teksto
  * @return {string} wika
  * @example
