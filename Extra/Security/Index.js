...
(async function(){
  ...
  /**
   * Lumilikha ito ng isang random na string ng isang ibinigay na haba
   * @param length - Ang haba ng string na bubuuin.
   * @returns Isang string ng mga random na character.
   */
  ...
  /**
   * Nagbabalik ito ng random na numero sa pagitan ng min at max na mga halaga.
   * @param min - Ang pinakamababang numero na maaaring mabuo.
   * @param max - Ang maximum na bilang na maaaring mabuo.
   * @returns Isang random na numero sa pagitan ng min at max na mga halaga.
   */
  ...
  /**
   * Lumilikha ito ng random na numero sa pagitan ng 0 at 489, pagkatapos ay ibinabawas ang random na numero sa pagitan ng 10 at 33 mula sa
   * ito, at pagkatapos ay magdagdag ng 10 dito.
   *
   * Kaya, ang resulta ay isang numero sa pagitan ng -23 at 489.
   *
   * Lumilikha din ang function ng isang random na numero sa pagitan ng 10 at 70, at isang random na numero sa pagitan ng 10 at 33.
   *
   * Ang function ay nagbabalik ng isang bagay na may mga sumusunod na katangian:
   *
   * Seguridad: ang random na numero sa pagitan ng 0 at 489
   * Nakaraan: ang random na numero sa pagitan ng -23 at 489
   * Lihim: ang random na numero sa pagitan ng 10 at 33
   * Numero: ang random na numero sa pagitan ng 10 at 70
   * @returns Isang bagay na may mga sumusunod na katangian:
   */
  ...
  function CreateSecurity() {
    ...
    return {
      ...
      Secret: Secret, // save
      Number: Between(10,70) // lokasyon ng real appstate minus 10
    }
  }

  /**
   * Sinusuri nito kung umiiral ang file, kung wala, gagawa ito at nagsusulat ng ilang data dito. Kung ito ay
   * umiiral, binabasa nito ang data mula dito at ibinabalik ito
   * @param DefaultPassWord - Ang password na gusto mong gamitin.
   * @returns Isang bagay na may mga sumusunod na katangian:
   */
  ...
  /**
   * Ang CreatePassWord() ay kumukuha ng isang string at isang bagay bilang mga argumento, at nagbabalik ng isang string.
   * @param DefaultPassWord - Ang default na password na gusto mong gamitin.
   * @param ParseObj - Ito ang bagay na na-parse.
   * @returns Isang string ng DefaultPassWord at ang PassWord array na pinagsama ng isang gitling.
   */
  ...
  /*Pag-encrypt ng AppState gamit ang PassWord. */
  ...
  /* Isang module na ginagamit upang i-encrypt at i-decrypt ang AppState. */
